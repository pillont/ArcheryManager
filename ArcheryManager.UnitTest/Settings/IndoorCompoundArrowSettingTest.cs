...
{
    [TestFixture]
    internal class IndoorCompoundArrowSettingTest
    {
        private readonly IArrowSetting Setting = IndoorCompoundArrowSetting.Instance;
        ...
        public void BorderColorZoneTest()
        {
            ...
            Assert.AreEqual(Color.Yellow, Setting.BorderColorZone(5));
        ...
        public void ScoreByIndexTest()
        {
            ...
            Assert.AreEqual("9", Setting.ScoreByIndex(5));
            Assert.AreEqual("10", Setting.ScoreByIndex(6));
